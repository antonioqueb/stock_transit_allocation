    ...
    def _compute_tc_allocation_qtys(self):
        for line in self:
            ...
            if line._tc_float_gt_zero(over_assigned_qty):
                ...
                # 'Pedir' en cualquiera de sus formas (botón Pedir del
                # carrito o Mandar pedido desde los tableros) = a compra,
                # aunque haya stock libre (regla del 21 sep 2026).
            ...
            if line._tc_float_le_zero(pending_qty):
                ...
                # Pedir manda: todo lo pendiente va a compra, nada al
