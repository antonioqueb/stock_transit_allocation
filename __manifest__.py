# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'security/multi_company_rules_analytics.xml',

        'data/ir_sequence_data.xml',
        'data/ir_config_parameter_data.xml',
        'data/ir_cron_data.xml',
        'data/stock_location_transit_fix.xml',
        'data/fix_duplicate_voyages.xml',
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            # Barra de progreso SOM para operaciones largas (asignar, comprar,
            # cerrar). La importan transit_allocation / to_be_allocated /
            ...
            'stock_transit_allocation/static/src/components/reception_flow_bar/reception_flow_bar.xml',
            'stock_transit_allocation/static/src/components/reception_flow_bar/reception_flow_bar.scss',
            ...
            # Folios many2many como hipervínculos (OC ligadas en la venta).
            'stock_transit_allocation/static/src/components/som_record_links/som_record_links.js',
            'stock_transit_allocation/static/src/components/som_record_links/som_record_links.xml',
        ...
        'stock_transit_allocation.assets_hubs': [
            ...
            'stock_transit_allocation/static/src/components/to_be_loading/to_be_loading.js',
            'stock_transit_allocation/static/src/components/to_be_loading/to_be_loading.xml',
            'stock_transit_allocation/static/src/components/to_be_loading/to_be_loading.scss',
